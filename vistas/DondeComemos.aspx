    ...
    <div class="row">
        <div class="col-md-6">
            <div class="md-3">
                ...
                <asp:TextBox runat="server" ID="txtbFiltro" AutoPostBack="true" OnTextChanged="Filtro_TextChanged" CssClass="form-control" />
            </div>
        </div>
    </div>
                ...
                <ItemTemplate>
                    <div class="col-md-4">
                        <div class="card" style="width: 100%; border-radius: 10px; overflow: hidden; margin: 10px; height: 100%;">
                            ...
                            <div class="card-body">
                                <h3 class="card-title">
                                    <a href='<%# "DetalleComerAfuera.aspx?id=" + Eval("Id") %>' style="color: black; text-decoration: none;"><%# Eval("name") %></a>
                                </h3>
                            </div>
                            <a href='<%# "DetalleComerAfuera.aspx?id=" + Eval("Id") %>'>
